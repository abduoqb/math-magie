const configProprietes = {
  ...
  genererQuestion: function() {
    ...
    const figures = [
      ...
      { nom: "Triangle", type: "2d", sommets: 3, cotes: 3, path: `<polygon points="50,15 85,85 15,85" fill="${couleur}" stroke="#fff" stroke-width="3"/>` },
      { nom: "Carré", type: "2d", sommets: 4, cotes: 4, path: `<rect x="15" y="15" width="70" height="70" fill="${couleur}" stroke="#fff" stroke-width="3"/>` },
      { nom: "Pentagone", type: "2d", sommets: 5, cotes: 5, path: `<polygon points="50,10 90,40 75,85 25,85 10,40" fill="${couleur}" stroke="#fff" stroke-width="3"/>` },
      { nom: "Hexagone", type: "2d", sommets: 6, cotes: 6, path: `<polygon points="50,10 85,30 85,70 50,90 15,70 15,30" fill="${couleur}" stroke="#fff" stroke-width="3"/>` },
      { nom: "Octogone", type: "2d", sommets: 8, cotes: 8, path: `<polygon points="30,10 70,10 90,30 90,70 70,90 30,90 10,70 10,30" fill="${couleur}" stroke="#fff" stroke-width="3"/>` },
      { nom: "Étoile", type: "2d", sommets: 10, cotes: 10, path: `<polygon points="50,5 63,38 98,38 70,59 78,95 50,75 22,95 30,59 2,38 37,38" fill="${couleur}" stroke="#fff" stroke-width="3"/>` },
