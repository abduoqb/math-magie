const configFormes = {
  ...
  genererQuestion: function(niveau = 1) {
    ...
    const formesNiv1 = [
      { nom: "Carré", path: `<rect x="15" y="15" width="70" height="70" fill="${couleur}" stroke="#334155" stroke-width="4"/>` },
      { nom: "Triangle", path: `<polygon points="50,15 85,85 15,85" fill="${couleur}" stroke="#334155" stroke-width="4"/>` },
      { nom: "Rectangle", path: `<rect x="10" y="30" width="80" height="40" fill="${couleur}" stroke="#334155" stroke-width="4"/>` },
      { nom: "Cercle", path: `<circle cx="50" cy="50" r="35" fill="${couleur}" stroke="#334155" stroke-width="4"/>` }
    ];

    const formesNiv2 = [
      ...formesNiv1,
      { nom: "Losange", path: `<polygon points="50,10 85,50 50,90 15,50" fill="${couleur}" stroke="#334155" stroke-width="4"/>` },
      { nom: "Hexagone", path: `<polygon points="50,10 85,30 85,70 50,90 15,70 15,30" fill="${couleur}" stroke="#334155" stroke-width="4"/>` },
      { 
        nom: "Cube", 
        path: `
      ...
      { 
        ...
        path: `
          ...
          <circle cx="50" cy="50" r="35" fill="${couleur}" stroke="#334155" stroke-width="4"/>
    ...
    const formesNiv3 = [
      ...formesNiv2,
      { nom: "Pentagone", path: `<polygon points="50,10 90,40 75,85 25,85 10,40" fill="${couleur}" stroke="#334155" stroke-width="4"/>` },
      { 
        nom: "Pyramide", 
        path: `
      ...
      { 
        nom: "Cylindre", 
        path: `
          <ellipse cx="50" cy="30" rx="25" ry="10" fill="${couleur}" fill-opacity="0.7" stroke="#334155" stroke-width="3"/>
          <rect x="25" y="30" width="50" height="40" fill="${couleur}" stroke-width="0"/>
          <ellipse cx="50" cy="70" rx="25" ry="10" fill="${couleur}" stroke="#334155" stroke-width="3"/>
          <line x1="25" y1="30" x2="25" y2="70" stroke="#334155" stroke-width="3"/>
          <line x1="75" y1="30" x2="75" y2="70" stroke="#334155" stroke-width="3"/>` 
      },
      { 
        nom: "Pavé droit", 
        path: `
      ...
      { 
        ...
        path: `
          <polygon points="50,15 80,75 20,75" fill="${couleur}"/>
          <ellipse cx="50" cy="75" rx="30" ry="10" fill="${couleur}" fill-opacity="0.8" stroke="#334155" stroke-width="3"/>
          <path d="M50,15 L20,75 M50,15 L80,75" fill="none" stroke="#334155" stroke-width="3"/>` 
      }
    ];
